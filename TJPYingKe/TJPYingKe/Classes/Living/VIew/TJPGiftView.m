...
#import "TJPGiftCollectionViewFlowLayout.h"
...
@interface TJPGiftView () <UICollectionViewDelegate, UICollectionViewDataSource>
...
- (UICollectionView *)giftCollectionView {
    if (!_giftCollectionView) {
        TJPGiftCollectionViewFlowLayout *layout = [[TJPGiftCollectionViewFlowLayout alloc] init];
        //设置item尺寸
        ...
        [giftCollectionView registerClass:[TJPGiftCollectionViewCell class] forCellWithReuseIdentifier:giftCollectionViewCell];
        ...
        [giftCollectionView registerClass:[TJPGiftCollectionViewCell class]
...
+ (instancetype)giftViewWithFrame:(CGRect)frame {
    TJPGiftView *giftView = [[TJPGiftView alloc] initWithFrame:frame];
    return giftView;
}
...
#pragma mark - method
- (void)setGiftData:(NSMutableArray<TJPGiftItem *> *)giftData {
    _giftData = giftData;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    TJPGiftItem *giftItem = _giftData[indexPath.row];
    NSString *urlStr;
